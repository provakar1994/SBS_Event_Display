...
// Fri Oct  8 16:11:05 2021 by ROOT version 6.24/06
...
#ifdef bbshower_cxx
bbshower::bbshower(TTree *tree) : fChain(0) 
{
...
Int_t bbshower::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t bbshower::LoadTree(Long64_t entry)
{
...
void bbshower::Show(Long64_t entry)
{
...
Int_t bbshower::Cut(Long64_t entry)
{
